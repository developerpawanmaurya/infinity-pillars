...
// TEST COPY of HomePage — the "Success Blueprints" showcase cards below drop
// their static rotate-* tilt (Chromium blurs rotated raster images at rest;
// confirmed via isolated CSS test). Delete this file + the /home-test route
// once the fix is confirmed either way.
const HomePageTest = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Home (Test — no tilt) - Infinity Pillars</title>
