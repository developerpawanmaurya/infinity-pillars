...
// Copy of the homepage — the closing "Shoot the birds" easter-egg game is
// swapped for StackPillarsSection, a Stack/Tower-Blocks-style precision game
// built on the site's own design tokens instead of a bespoke scene. Everything
// else on the page is unchanged, so this can be compared against / at the
// live homepage.
...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Infinity Pillars — Experiment 4 (Stack the Pillars)</title>
