...
// ThreeTunnelSection's real WebGL scroll-driven tunnel (grid-lined corridor,
// image planes on floor/ceiling/walls, infinite segment recycling) instead
// of experiment-4's simpler CSS flythrough. Everything else (Header, Five
// Phases, Lime Reveal, CTA, Footer) is untouched.
const PlaybookExperiment5 = () => {
  const steps = [
    {
      step: '01',
  ...
  return (
    <>
      <Helmet>
        <title>The Playbook — Experiment 5</title>
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        {/* Hero Image — real WebGL scroll-driven tunnel */}
        <ThreeTunnelSection />
...
export default PlaybookExperiment5;
