...
import ImageTunnelSection from '@/components/ImageTunnelSection.jsx';
import { Button } from '@/components/ui/button';
import { Link } from 'react-router-dom';

// Copy of AboutPage ("The Playbook") — the only change is the static Hero
// Image section, replaced with ImageTunnelSection's scroll-driven flythrough
// of 5 images. Everything else (Header, Five Phases, Lime Reveal, CTA,
// Footer) is untouched.
const PlaybookExperiment4 = () => {
  const steps = [
    {
      step: '01',
  ...
  return (
    <>
      <Helmet>
        <title>The Playbook — Experiment 4</title>
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        {/* Hero Image — scroll-driven flythrough of 5 images instead of a
            single static photo */}
        <ImageTunnelSection />
...
export default PlaybookExperiment4;
