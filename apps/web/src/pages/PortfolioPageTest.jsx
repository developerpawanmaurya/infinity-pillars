...
import PortfolioCaseCardTest from '@/components/PortfolioCaseCardTest.jsx';
...
const PortfolioPageTest = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Success Blueprints (Test) - Infinity Pillars</title>
        ...
        <section className="pt-40 pb-24 md:pt-56 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-6xl md:text-8xl lg:text-[7rem] font-bold tracking-tighter leading-[0.9] mb-12">
              ...
              <span className="block text-2xl text-primary mt-4">(Test build — no tilt)</span>
            </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="space-y-40 md:space-y-56">
              {projects.map((project, index) => (
                <PortfolioCaseCardTest key={project.title} project={project} index={index} />
              ))}
            </div>
          </div>
        </section>
