...
// One flagship case-study card: index badge, title clip-reveal, curtain-wipe
// image, staggered metric pills, and a mouse-tilt frame — all driven by a
// single GSAP timeline per card so nothing races against a second animation
// system for the same element (that race was what made the first card,
// closest to the fold, glitch on load).
const PortfolioCaseCard = ({ project, index }) => {
